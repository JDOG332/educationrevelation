...
export const POEMS = [
  ...
  ["Every chance,", "a change."],
  ["Every thought,", "a seed..."],
  ["Every word,", "a deed."],
  ["Every deed,", "received."],
  ["Every sun always setting,", "but rising again..."],
  ["Always the storm raging,", "but clearing to an end."],
  ["Always the road bending,", "but never-ending."],
  ["Every person, a story...", "waiting to be told."],
  ["Every picture, a purpose...", "starting to unfold."],
  ["Every piece of the puzzle...", "starting to take hold."],
